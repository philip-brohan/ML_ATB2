...
testImages = getImageDataset(subdir="boxes", purpose="test", nImages=args.nimages)
testNumbers = getNumbersDataset(subdir="boxes", purpose="test", nImages=args.nimages)
...
for testCase in testData:
    image = testCase[0]
    orig = testCase[1]
    encoded = transcriber(tf.reshape(image, [1, 36, 48, 3]), training=False)
