...
# Convert a fake rainfall grid-cell image to a tensor
...
image = Image.open("%s/OCR-fake-box/images/%s.png" % (os.getenv("SCRATCH"), args.docn))

# Output the tensor
opdir = "%s/ML_ATB2/boxes/tensors/images/" % os.getenv("SCRATCH")
